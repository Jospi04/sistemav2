    ...
    <div class="login-wrapper">
        <main class="login-card-adaline">
            ...
            <?php if (isset($_SESSION['error'])): ?>
                <div class="alert-forest-box" role="alert">
                    <div class="alert-icon-svg">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="alert-svg">
                ...
                <div class="form-field-group">
                    ...
                    <div class="input-container">
                        <span class="field-icon">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="field-svg">
                                <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>
                                <circle cx="12" cy="7" r="4"/>
                            </svg>
                        </span>
                        <input type="text" id="username" name="usuario" required placeholder="Ej. administrador" autocomplete="username">
                    </div>
                </div>
            ...
            <footer class="login-footer">
                <p class="font-mono">&copy; 2026 PetroAdmin. Securizado.</p>
            </footer>
